...
public class ModItems {
    ...
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, CreateHollowPurpleMod.MODID);
    ...
    public static final RegistryObject<Item> PURNITE_BUCKET = ITEMS.register("purnite_bucket",
        () -> new BucketItem(ModFluids.PURNITE_SOURCE, new Item.Properties().craftRemainder(Items.BUCKET).tab(CreativeTabs.TAB_HOLLOW_PURPLE).stacksTo(1)));
    ...
    public static void register(IEventBus eventBus) {
        LOGGER.info("i think the items loaded as well");
